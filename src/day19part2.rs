...
fn simulate(before_state: (i32, i32, i32, i32), resources: &mut [i32;4], robots: &mut [i32;4], costs: &[Vec<(i32, usize)>; 4], time: usize, memo: &mut HashMap::<((i32, i32, i32, i32), (i32, i32, i32, i32)), (usize, (i32, i32, i32, i32))>) -> i32 {
